...
const loadQuestions = async () => {
  try {
    const response = await fetch('/mathlogic.json');
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
          <div class="p-6 sm:px-20 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
            ...
            <div v-if="!testStarted" class="text-center">
              ...
              <p class="mb-4 text-gray-600 dark:text-gray-400">Test your math and logic skills with our practice questions. Each question is designed to challenge different aspects of mathematical thinking.</p>
