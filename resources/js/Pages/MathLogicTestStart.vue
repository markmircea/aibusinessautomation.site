...
3. Create an explanation object that MUST follow this EXACT structure:
   {
     "correctAnswerExplanation": "A detailed step-by-step explanation of how to solve the problem and why the correct answer is correct",
     "commonMisconceptions": [
       "First common error or misconception that might lead to a wrong answer",
       "Second common error or misconception"
     ],
     "keyConcepts": [
       "First key mathematical or logical concept demonstrated in this problem",
       "Second key concept or skill required to solve this problem"
     ]
   }
